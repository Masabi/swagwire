...
Latest version 1.0.11-openapi3
...
buildscript {
    ...
    dependencies {
        compile("com.masabi.swagwire:swagwire-codegen:1.0.11-openapi3")
    }
}
...
dependencies {
    testImplementation("com.masabi.swagwire:swagwire-core:1.0.11-openapi3")
}
```
